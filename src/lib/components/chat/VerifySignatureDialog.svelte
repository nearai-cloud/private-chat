	...
	>
		...
		>
			...
			<div class="px-6 pt-4 pb-6">
                ...
                <div class="flex items-center gap-2 mb-4 py-2 px-2.5 text-[#00a186] bg-[#ccf4ed] border border-[#ccf4ed] rounded-lg text-sm">
                    <CheckIcon />
                    Message Signature Verified.
                </div>
                {/if}
                {#if verifyStatus === 'error'}
                <div class="flex items-center gap-2 mb-4 py-2 px-2.5 text-[#b02a37] bg-[#f8d7da] border border-[#f1aeb5] rounded-lg text-sm">
